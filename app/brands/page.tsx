...
export const metadata: Metadata = {
  ...defaultMetadata,
  title: {
    default: 'Designer Brands Collection',
        ...
        >
          {brands.map((brand, index) => (
            <div
              key={index}
              role="listitem"
              className="flex items-center justify-center p-6 h-[215px] sm:h-[250px] bg-white border-[1px] border-footerBrown border-opacity-20 rounded-lg shadow-md sm:hover:shadow-xl transition-all duration-200 sm:hover:scale-105"
