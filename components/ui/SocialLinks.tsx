...
export function SocialLinks({ color }: SocialLinksProps) {
  return (
    <nav className="flex gap-[8px] items-center">
      ...
      >
        <svg
          ...
          className="w-[24px] h-[24px] transition-colors hover:text-gray-300"
          role="img"
      ...
      <Link
        ...
        title="Follow Suits 20/20 on Facebook"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          ...
          fill="currentColor"
          stroke="none"
          className="w-[24px] h-[24px] scale-x-[1.25] ml-[4px] transition-colors hover:text-gray-300"
          role="img"
      ...
      <Link
        href="https://www.tiktok.com/@suits2020chicago?lang=en"
        target="_blank"
        rel="noopener noreferrer"
        style={{ color }}
        aria-label="Visit our TikTok page"
        title="Follow Suits 20/20 on TikTok"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          ...
          fill="currentColor"
          stroke="none"
          className="w-[24px] h-[24px] scale-y-[0.95] transition-colors hover:text-gray-300"
          role="img"
          aria-labelledby="tiktokTitle"
        >
          <title id="tiktokTitle">TikTok Icon</title>
